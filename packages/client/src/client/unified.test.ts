/**
 * @lens/client - Unified Client Tests
 *
 * Tests for unified client (V2 Operations + V1 Optimization Layer).
 */

import { describe, it, expect, beforeEach } from "bun:test";
import { z } from "zod";
import { entity, t, query, mutation, type Update } from "@lens/core";
import { createUnifiedClient, type UnifiedTransport, type QueriesMap, type MutationsMap } from "./unified";
...
}): UnifiedTransport & { subscriptions: MockSubscription[]; emit: (index: number, data: unknown) => void } {
